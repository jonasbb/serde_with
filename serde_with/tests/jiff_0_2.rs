...
#[test]
fn test_jiff_duration_seconds() {
    let zero = SignedDuration::new(0, 0);
    let one_second = SignedDuration::new(1, 0);
    ...
    #[serde_as]
    #[derive(Debug, Serialize, Deserialize, PartialEq)]
    struct Structf64Flexible(#[serde_as(as = "DurationSeconds<f64, Flexible>")] SignedDuration);
    ...
    struct StructStringFlexible(
        #[serde_as(as = "DurationSeconds<String, Flexible>")] SignedDuration,
    );
...
#[test]
fn test_jiff_duration_seconds_with_frac() {
    let zero = SignedDuration::new(0, 0);
    let one_second = SignedDuration::new(1, 0);
    let half_second = SignedDuration::new(0, 500_000_000);
    let minus_one_second = zero - one_second;
    ...
    #[derive(Debug, Serialize, Deserialize, PartialEq)]
    struct StructStringFlexible(
        #[serde_as(as = "DurationSecondsWithFrac<String, Flexible>")] SignedDuration,
    );
